...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface LocaleNamespaceMap {
    /** Flat session list, its archive and pending groups, and the new-session dialog. */
...
export const zh = {
  ...
  'empty.none': '暂无会话',
  'empty.allArchived': '所有会话都已归档',
  'row.archive': '归档',
  'row.archive.title': '归档：从主列表移入已归档分组，日志保留',
  'group.archived': '已归档',
  'group.pending': '待删除',
  'group.pending.note': '重启后清除',
  'multi.selectAll': '全选',
  'multi.selectNone': '全不选',
  'multi.restore': '恢复({count})',
  'multi.restore.title': '恢复选中会话到主列表',
  'multi.delete': '删除({count})',
  'multi.delete.title': '清除选中会话的全部历史',
  'multi.enter': '多选',
  'multi.enter.title': '多选：批量恢复或删除归档会话',
  'multi.exit': '取消',
  'multi.exit.title': '退出多选',
  'row.restore': '恢复',
  'row.restore.title': '恢复：移回主列表',
  'row.delete': '删除',
  'row.delete.title': '删除：清除该会话的全部历史',
  'row.cancel': '取消',
  'row.cancel.title': '取消：撤销删除并移回主列表',
  'dialog.delete.title': '删除会话',
  'dialog.delete.titleBatch': '删除 {count} 个会话',
  'dialog.delete.body': '将清除「{title}」的全部历史：agent 对话记录与终端日志一并删除，无法恢复。',
  'dialog.delete.bodyBatch': '将清除选中的 {count} 个会话的全部历史：agent 对话记录与终端日志一并删除，无法恢复。',
...
export const en = {
  ...
  'empty.allArchived': 'All sessions are archived',
  'row.archive': 'Archive',
  'row.archive.title': 'Archive: move out of the main list into the archived group, keeping the log',
  'group.archived': 'Archived',
  'group.pending': 'Pending deletion',
  'group.pending.note': 'Cleared on restart',
  'multi.selectAll': 'Select all',
  'multi.selectNone': 'Deselect all',
  'multi.restore': 'Restore ({count})',
  'multi.restore.title': 'Restore the selected sessions to the main list',
  'multi.delete': 'Delete ({count})',
  'multi.delete.title': 'Clear the full history of the selected sessions',
  'multi.enter': 'Select',
  'multi.enter.title': 'Select: restore or delete archived sessions in bulk',
  'multi.exit': 'Cancel',
  'multi.exit.title': 'Exit selection mode',
  'row.restore': 'Restore',
  'row.restore.title': 'Restore: move back to the main list',
  'row.delete': 'Delete',
  ...
  'dialog.delete.titleBatch': 'Delete {count} sessions',
  ...
  'dialog.delete.bodyBatch': 'This clears the full history of the {count} selected sessions: the agent transcripts and terminal logs are deleted together, with no way to recover them.',
