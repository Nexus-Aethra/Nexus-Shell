...
export const BUFFER_PROMPT_TEXT =
  ...
  + 'rooted at / — action="ls" with no path (or "/") lists the mapped roots, and read / edit / download / '
  + 'upload all take buffer paths like /as/sub/file — no grant id needed; paths outside the mapped areas '
  + 'are refused. '
